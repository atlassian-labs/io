...
publishing {
    val publication = publications.create("mavenJava", MavenPublication::class.java) {
        pom {
            scm {
                url.set("https://bitbucket.org/atlassian/io")
                connection.set("scm:git:git@bitbucket.org:atlassian/io.git")
                developerConnection.set("scm:git:git@bitbucket.org:atlassian/io.git")
            }
        }
    }
